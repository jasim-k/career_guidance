 ...
 */
	...
	public function search($query= null)
	{
	  	...
	  	$query=	$this->request->data['City']['Enter_Code'];
	 	
	  	$cq=$this->City->query("SELECT * FROM Cities INNER JOIN States ON cities.state_id = states.id WHERE cities.name LIKE '%".$query."%'");
		...
		$this->set($this->set('cities',$cq),$this->Paginator->paginate());
		// pr($cq); exit;
